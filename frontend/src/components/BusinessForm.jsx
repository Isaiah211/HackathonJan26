  ...
  return (
    <div className="card p-6 space-y-6">
      <div className="flex items-center justify-between">
        ...
        <HelpTooltip content="Enter business details to analyze impact on the map" />
      </div>
            ...
            <div className="flex items-center gap-3">
              ...
              <div>
                ...
                <p className="text-xs text-neutral-500 mt-0.5">
                  Impact multipliers applied: Jobs ×{selectedCategory.impactMultipliers.jobs}, 
                  Revenue ×{selectedCategory.impactMultipliers.revenue}
                </p>
              </div>
            </div>
          </div>
