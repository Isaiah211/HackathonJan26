...
import { TrendingUp, Users, DollarSign, TrendingDown, ChevronDown, ChevronUp, Building2 } from 'lucide-react';
...
const ResultsPanel = ({ businesses = [], selectedBusinessId, onExportPDF }) => {
  ...
  return (
    <div className="h-full overflow-y-auto" id="results-panel">
